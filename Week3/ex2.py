...
def write_to_file(students):
    ...
    """
    with open('students_closest_to_finishing.csv', 'w', newline='', encoding='UTF-8') as stud_file:
        ...
        try:
            ...
            for s in tmp:
                output_writer.writerow([s.name, s.gender, s.get_progression(), s.image_url])

#peter = ex1.Student('Peter', 'Male', ex1.DataSheet([]), 'img')
#write_to_file([peter])
